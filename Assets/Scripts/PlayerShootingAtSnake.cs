...
{
    public class PlayerShootingAtSnake : MonoBehaviour
    {
...
*/
        ...
        void Awake()
        {
            ...
            Cyclone = gameObject.transform.FindChild("WandTip").FindChild("Cyclone").gameObject;
        ...
        public void ShootFire()
        {
            ...
            if (Physics.Raycast(shootRay, out shootHit, range, shootableMask))
            {
                ...
                EnemyHealthSnake enemyHealth = shootHit.collider.GetComponent<EnemyHealthSnake>();
